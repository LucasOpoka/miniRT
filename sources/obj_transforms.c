...
/*   Updated: 2024/09/02 17:48:01 by lopoka           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_set_obj_matrices(t_obj *obj)
{
	...
	ft_combine_obj_transforms(obj, &scaling_mtrx, &rot_mtrx, &trnsl_mtrx);
}
...
void	ft_set_rot_mtrx(t_mtrx4 *rot_mtrx, t_obj *obj)
{
	...
	ft_rot_mtrx_from_axis_and_angle(rot_mtrx, rot_axis, rot_angle);
}

// Set rotation matrix of an object
// https://en.wikipedia.org/wiki/Rotation_matrix
void	ft_rot_mtrx_from_axis_and_angle(t_mtrx4 *rot_mtrx, t_vct r_ax, double r_angle)
{
	double	cs;
	double	sn;
	double	one_min_cs;
