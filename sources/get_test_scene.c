...
/*   Updated: 2024/09/05 14:25:10 by lopoka           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_scene	get_test_scene(void)
{
	...
	obj3->type = t_sphere;
	obj3->pos = ft_create_vct(0, 0, 0); //ON THE LEFT
	obj3->radius = 0.5;
	...
	// Triangle testing
	t_vct p1 = ft_create_vct(-1, 0, 2);
	t_vct p2 = ft_create_vct(1, 0, 2);
	t_vct p3 = ft_create_vct(0, 1, 2);
